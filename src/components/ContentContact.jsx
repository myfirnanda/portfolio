const ContentContact = () => {
    return (
        <div id="contact" className="pt-16 mb-20 sm:mb-28 lg:mb-36 px-4 sm:px-6 relative overflow-hidden">
            <div className="static-star static-star-contact-8"></div>
            <div className="static-star static-star-contact-18"></div>
            <div className="static-star static-star-contact-23"></div>
            <div className="static-star static-star-contact-25"></div>
